...
?>
<form action="<?php echo Route::_('index.php?option=com_gilla&view=incident&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="incidents-form" class="form-validate">
	...
	<div>
		...
		<div class="row">
			<div class="col-lg-9">
				<div>
					...
					<?php echo $this->form->renderField('date_heure_fermeture'); ?>
					<?php echo $this->form->renderField('commentaire_agent'); ?>
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'picture', Text::_('COM_GILLA_PICTURE')); ?>
		<div class="row">
			<div class="col-md-12">
