...
?>
<form action="<?php echo Route::_('index.php?option=com_gilla&view=emplacement&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="emplacements-form" class="form-validate">
	...
	<div>
		...
		<div class="row">
			<div class="col-lg-9">
				<div>
					<?php echo $this->form->renderField('emplacement'); ?>
