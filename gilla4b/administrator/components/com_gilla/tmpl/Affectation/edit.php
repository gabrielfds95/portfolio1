...
?>
<form action="<?php echo Route::_('index.php?option=com_gilla&view=affectation&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="affectations-form" class="form-validate">
