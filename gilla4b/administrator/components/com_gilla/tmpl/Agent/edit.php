...
?>
<form action="<?php echo Route::_('index.php?option=com_gilla&view=Agent&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="agents-form" class="form-validate">
