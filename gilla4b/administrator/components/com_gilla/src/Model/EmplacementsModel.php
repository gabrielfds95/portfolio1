 ...
 * @since  1.6
 */
class EmplacementsModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from('#__gilla_emplacements AS a');
		$query->select('p.emplacement AS parent')->join('LEFT','#__gilla_emplacements AS p ON a.emplacements_id = p.id');
		...
		if (!empty($search))
		{
			...
			$searches[] ='a.emplacement LIKE '.$search;
