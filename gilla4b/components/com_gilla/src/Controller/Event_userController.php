...
class Event_userController extends FormController
{
	 ...
	 * @since  4.0.0
	 */
	protected $view_item = 'event_user_e';
	 ...
	 * @since   4.0.0
	 */
	public function getModel($name = 'event_user_e', $prefix = '', $config = ['ignore_request' => true])
	{
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		if ($user->authorise('core.edit.own', com_gilla)) {
			$recordCreatedByUser = ($record->created_by == $user->id);   // TEST DEBUG
