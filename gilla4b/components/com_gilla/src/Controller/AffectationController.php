 ...
 * @since  4.0.0
 */
class AffectationController extends FormController
{
	/**
	 ...
	 * @since  4.0.0
	 */
	protected $view_item = 'affectation_e';
	 ...
	 * @since   4.0.0
	 */
	public function getModel($name = 'affectation_e', $prefix = '', $config = ['ignore_request' => true])
	{
