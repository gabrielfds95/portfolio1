	...
	<div>
		...
		<div class="btn-group btn-outline-success">
			<a class="btn" title="<?php echo Text::_('COM_GILLA_NEW');?>"
				href="<?php echo GillaHelperRoute::_(true, 'affectation_e', 'edit', 0); ?>">
		...
		<table class="table table-striped" id="eventsList">
			<thead>
				<tr>
					...
					<th scope="col">
						<?php echo HTMLHelper::_('grid.sort', 'COM_GILLA_AFFECTATIONS_DATE_HEURE_DEBUT', 'a.date_heure_debut', $listDirn, $listOrder); ?>
					</th>
					<th scope="col">
						<?php echo HTMLHelper::_('grid.sort', 'COM_GILLA_AFFECTATIONS_DATE_HEURE_FIN', 'a.date_heure_fin', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="<?php echo GillaHelperRoute::_(false, 'affectation', null, $item->id, $slug, $Itemid); ?>">
