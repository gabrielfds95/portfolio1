...
$this->tab_name = 'com-gilla-agent_e';
...
<form action="<?php echo Route::_('index.php?option=com_gilla&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
	<fieldset>
		...
		<?php echo HTMLHelper::_('uitab.addTab', $this->tab_name, 'details', Text::_('COM_GILLA_AGENT')); ?>
	...
	<div class="mb-2">
		<button type="button" class="btn btn-outline-success" onclick="Joomla.submitbutton('agent.save')">
			<span class="icon-check" aria-hidden="true"></span>
			<?php echo Text::_('JSAVE'); ?>
		</button>
		<button type="button" class="btn btn-outline-primary" onclick="Joomla.submitbutton('agent.cancel')">
