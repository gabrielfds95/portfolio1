...
<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	<div>
		...
		<div class="btn-group btn-outline-success">
			<a class="btn" title="<?php echo Text::_('COM_GILLA_NEW');?>"
				href="<?php echo GillaHelperRoute::_(true, 'agent_e', 'edit', 0); ?>">
	...
	<div>
		<table class="table table-striped" id="agentsList">
			<thead>
				<tr>
					<th scope="col">
						<?php echo HTMLHelper::_('grid.sort', 'COM_GILLA_AGENTS_TELEPHONE', 'a.telephone', $listDirn, $listOrder); ?>
					</th>
					<th scope="col">
			...
			<tbody>
				<?php foreach ($this->items as $id => $item) :
					$slug = preg_replace('/[^a-z\d]/i', '-', $item->telephone);
					$slug = strtolower(str_replace(' ', '-', $slug));
				?>
				<tr>
			
					<td>
						<a href="<?php echo GillaHelperRoute::_(false, 'agent', null, $item->id, $slug, $Itemid); ?>">
						<?php echo $item->telephone; ?></a></td>
