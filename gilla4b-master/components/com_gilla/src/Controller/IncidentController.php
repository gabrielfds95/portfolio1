 ...
 * @since  4.0.0
 */
class IncidentController extends FormController
{
	/**
	 ...
	 * @since  4.0.0
	 */
	protected $view_item = 'incident_e';
	 ...
	 * @since   4.0.0
	 */
	public function getModel($name = 'incident_e', $prefix = '', $config = ['ignore_request' => true])
	{
