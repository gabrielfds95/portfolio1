 ...
 * @since  4.0.0
 */
class Event_eModel extends \J4xSio\Component\Gilla\Administrator\Model\EventModel
{
	/**
	 ...
	 * @throws  \Exception
	 */
	public function getTable($name = 'Events', $prefix = 'Administrator', $options = [])
	{
