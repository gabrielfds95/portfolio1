...
<form action="<?php echo Route::_('index.php?option=com_gilla&view=event_user&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="events-users-form" class="form-validate">
	...
	<div>
		...
		<div class="row">
			<div class="col-lg-9">
				...
				<?php $this->form->setValue('events_id', null, $events_id); ?>
