...
?>
<form action="<?php echo Route::_('index.php?option=com_gilla&view=event&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" name="adminForm" id="events-form" class="form-validate">
