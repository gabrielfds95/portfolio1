...
class TypesModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->from('#__gilla_types AS a');
		$query->select('p.type AS parent')->join('LEFT','#__gilla_types AS p ON a.types_id = p.id');
		...
		//echo nl2br(str_replace('#__','gilla4a_',$query));			// TEST/DEBUG
		return $query;
	}
