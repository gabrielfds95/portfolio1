...
/**
 * Prise_en_charges table
 *
 * @since  1.5
 */
class Prise_en_chargesTable extends Table
{
	/**
	 * Constructor
	 *
	...
	{
		$this->typeAlias = 'com_gilla.prise_en_charge';
		parent::__construct('#__gilla_prise_en_charges', 'id', $db);
	}
